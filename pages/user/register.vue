      ...
      <v-flex>
        <v-card>
          ...
          <v-card-actions style="justify-content: center;">
            <v-btn color="primary" @click="registerUser()">Đăng kí</v-btn>
...
export default {
  ...
  methods: {
    ...
    async registerUser() {
      ...
      formData.append('number_phone', this.register.number_phone);
      formData.append('image_file', this.imageFile);

      await this.$axios.post(axiosUrl.baseUrl + '/user/register', formData)
          .then(async (res) => {
            this.loading();
